...
function resize_photo($temp_photo, $normal_photo_max_w, $normal_photo_max_h){
  ...
  //mis image objektile, mis objektist võtate, mis koordinaatidele x, y, mis koordinaatidelt võtta x, y, kui laialt, kui kõrgelt, kui laialt võtame, kui kõrgelt võtame
